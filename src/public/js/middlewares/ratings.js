...
export function getRatingStatistics(ratings)
{
    ...
    statistics.push((stars.star1 / ratings.length) * 100);
    statistics.push((stars.star2 / ratings.length) * 100);
    statistics.push((stars.star3 / ratings.length) * 100);
    statistics.push((stars.star4 / ratings.length) * 100);
    statistics.push((stars.star5 / ratings.length) * 100);
