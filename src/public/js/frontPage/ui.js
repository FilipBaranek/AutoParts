...
function setupCategories()
{
    ...
    categoryCards.forEach(category => {
        category.addEventListener('click', () => {
            ...
            {
                const encodedEngineValue = sessionStorage.getItem('engine').replace(/\s+/g, '_');
                
                window.location.href = `/category?catName=${category.querySelector('img').alt}&engine=${encodedEngineValue}`;
